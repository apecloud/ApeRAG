...
`,
  ...
  'quota.max_collection_count': 'Collection Count',
  'quota.max_document_count': 'Total Documents in All Collections',
  'quota.max_document_count_per_collection': 'Documents per Collection',
  'quota.max_bot_count': 'Bot Count',
  ...
  'quota.management_tips': 'Manage user quotas and knowledge base usage',
  'quota.my_quotas': 'My Quotas',
  'quota.quotas': 'Quota Information',
