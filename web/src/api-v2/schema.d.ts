...
export interface components {
    schemas: {
         ...
         * @description Static capability matrix for the deployment's vector backend.
         *
        ...
        VectorBackendCapabilities: {
            /**
             * Supports Atomic Batch Upsert
             * @description Whether the backend guarantees atomic visibility of a batch upsert. Per task #83 P1-V2.
             */
            supports_atomic_batch_upsert: boolean;
            /**
             * Supports Filter Or With Empty Parts
             * @description Whether the backend accepts a top-level OR filter that contains empty/no-op parts. Per task #83 P1-V3.
             */
            supports_filter_or_with_empty_parts: boolean;
            /**
             * Supports Legacy Mode
             * @description Whether the backend exposes a legacy compatibility mode that the platform may still create/read. Per task #83 P1-V4.
             */
            supports_legacy_mode: boolean;
        };
        /**
         * VectorBackendInfo
         * @description Deployment vector backend identity + capability projection.
         *
        ...
        VectorBackendInfo: {
            ...
            capabilities: components["schemas"]["VectorBackendCapabilities"];
        };
        /** VectorSearchParams */
        VectorSearchParams: {
            /**
