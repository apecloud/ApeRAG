...
// @ts-ignore
import type { TurnFeedback } from '../models';
// @ts-ignore
import type { TurnFeedbackList } from '../models';
// @ts-ignore
import type { TurnFeedbackWrite } from '../models';
// @ts-ignore
...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * Get all persisted feedback states for turns in a chat
         * @summary List turn feedback for a chat
         * @param {string} chatId
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        chatsChatIdFeedbackGet: async (chatId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'chatId' is not null or undefined
            assertParamExists('chatsChatIdFeedbackGet', 'chatId', chatId)
            const localVarPath = `/chats/{chat_id}/feedback`
                .replace(`{${"chat_id"}}`, encodeURIComponent(String(chatId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
        ...
        /**
         * Remove persisted feedback state for a turn
         * @summary Delete turn feedback
         * @param {string} chatId
         * @param {string} turnId
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        chatsChatIdTurnsTurnIdFeedbackDelete: async (chatId: string, turnId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'chatId' is not null or undefined
            assertParamExists('chatsChatIdTurnsTurnIdFeedbackDelete', 'chatId', chatId)
            // verify required parameter 'turnId' is not null or undefined
            assertParamExists('chatsChatIdTurnsTurnIdFeedbackDelete', 'turnId', turnId)
            const localVarPath = `/chats/{chat_id}/turns/{turn_id}/feedback`
                .replace(`{${"chat_id"}}`, encodeURIComponent(String(chatId)))
        ...
        /**
         * Persist the feedback state for a turn
         * @summary Create or update turn feedback
         * @param {string} chatId
         * @param {string} turnId
         * @param {TurnFeedbackWrite} turnFeedbackWrite
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        chatsChatIdTurnsTurnIdFeedbackPost: async (chatId: string, turnId: string, turnFeedbackWrite: TurnFeedbackWrite, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'chatId' is not null or undefined
            assertParamExists('chatsChatIdTurnsTurnIdFeedbackPost', 'chatId', chatId)
            // verify required parameter 'turnId' is not null or undefined
            assertParamExists('chatsChatIdTurnsTurnIdFeedbackPost', 'turnId', turnId)
            // verify required parameter 'turnFeedbackWrite' is not null or undefined
            assertParamExists('chatsChatIdTurnsTurnIdFeedbackPost', 'turnFeedbackWrite', turnFeedbackWrite)
            const localVarPath = `/chats/{chat_id}/turns/{turn_id}/feedback`
                .replace(`{${"chat_id"}}`, encodeURIComponent(String(chatId)))
                .replace(`{${"turn_id"}}`, encodeURIComponent(String(turnId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(turnFeedbackWrite, localVarRequestOptions, configuration)
...
export const DefaultApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async chatsChatIdFeedbackGet(chatId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TurnFeedbackList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.chatsChatIdFeedbackGet(chatId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.chatsChatIdFeedbackGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Remove persisted feedback state for a turn
         ...
         * @throws {RequiredError}
         */
        async chatsChatIdTurnsTurnIdFeedbackDelete(chatId: string, turnId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.chatsChatIdTurnsTurnIdFeedbackDelete(chatId, turnId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.chatsChatIdTurnsTurnIdFeedbackDelete']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Persist the feedback state for a turn
         ...
         * @throws {RequiredError}
         */
        async chatsChatIdTurnsTurnIdFeedbackPost(chatId: string, turnId: string, turnFeedbackWrite: TurnFeedbackWrite, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TurnFeedback>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.chatsChatIdTurnsTurnIdFeedbackPost(chatId, turnId, turnFeedbackWrite, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.chatsChatIdTurnsTurnIdFeedbackPost']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Delete a collection
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * Get all persisted feedback states for turns in a chat
         * @summary List turn feedback for a chat
         * @param {DefaultApiChatsChatIdFeedbackGetRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        chatsChatIdFeedbackGet(requestParameters: DefaultApiChatsChatIdFeedbackGetRequest, options?: RawAxiosRequestConfig): AxiosPromise<TurnFeedbackList> {
            return localVarFp.chatsChatIdFeedbackGet(requestParameters.chatId, options).then((request) => request(axios, basePath));
        },
        /**
         * Remove persisted feedback state for a turn
         * @summary Delete turn feedback
         * @param {DefaultApiChatsChatIdTurnsTurnIdFeedbackDeleteRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        chatsChatIdTurnsTurnIdFeedbackDelete(requestParameters: DefaultApiChatsChatIdTurnsTurnIdFeedbackDeleteRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.chatsChatIdTurnsTurnIdFeedbackDelete(requestParameters.chatId, requestParameters.turnId, options).then((request) => request(axios, basePath));
        },
        /**
         * Persist the feedback state for a turn
         * @summary Create or update turn feedback
         * @param {DefaultApiChatsChatIdTurnsTurnIdFeedbackPostRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        chatsChatIdTurnsTurnIdFeedbackPost(requestParameters: DefaultApiChatsChatIdTurnsTurnIdFeedbackPostRequest, options?: RawAxiosRequestConfig): AxiosPromise<TurnFeedback> {
            return localVarFp.chatsChatIdTurnsTurnIdFeedbackPost(requestParameters.chatId, requestParameters.turnId, requestParameters.turnFeedbackWrite, options).then((request) => request(axios, basePath));
        },
        /**
         * Delete a collection
         * @summary Delete a collection
...
/**
 * Request parameters for chatsChatIdFeedbackGet operation in DefaultApi.
 * @export
 * @interface DefaultApiChatsChatIdFeedbackGetRequest
 */
export interface DefaultApiChatsChatIdFeedbackGetRequest {
    /**
     *
     * @type {string}
     * @memberof DefaultApiChatsChatIdFeedbackGet
     */
    readonly chatId: string
}

/**
 * Request parameters for chatsChatIdTurnsTurnIdFeedbackDelete operation in DefaultApi.
 * @export
 * @interface DefaultApiChatsChatIdTurnsTurnIdFeedbackDeleteRequest
 */
export interface DefaultApiChatsChatIdTurnsTurnIdFeedbackDeleteRequest {
    /**
     *
     * @type {string}
     * @memberof DefaultApiChatsChatIdTurnsTurnIdFeedbackDelete
     */
    readonly chatId: string
...
/**
 * Request parameters for chatsChatIdTurnsTurnIdFeedbackPost operation in DefaultApi.
 * @export
 * @interface DefaultApiChatsChatIdTurnsTurnIdFeedbackPostRequest
 */
export interface DefaultApiChatsChatIdTurnsTurnIdFeedbackPostRequest {
    /**
     *
     * @type {string}
     * @memberof DefaultApiChatsChatIdTurnsTurnIdFeedbackPost
     */
    readonly chatId: string
    ...
    /**
     *
     * @type {TurnFeedbackWrite}
     * @memberof DefaultApiChatsChatIdTurnsTurnIdFeedbackPost
     */
    readonly turnFeedbackWrite: TurnFeedbackWrite
}
...
export class DefaultApi extends BaseAPI implements DefaultApiInterface {
     ...
     * @memberof DefaultApi
     */
    public chatsChatIdFeedbackGet(requestParameters: DefaultApiChatsChatIdFeedbackGetRequest, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).chatsChatIdFeedbackGet(requestParameters.chatId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public chatsChatIdTurnsTurnIdFeedbackDelete(requestParameters: DefaultApiChatsChatIdTurnsTurnIdFeedbackDeleteRequest, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).chatsChatIdTurnsTurnIdFeedbackDelete(requestParameters.chatId, requestParameters.turnId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public chatsChatIdTurnsTurnIdFeedbackPost(requestParameters: DefaultApiChatsChatIdTurnsTurnIdFeedbackPostRequest, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).chatsChatIdTurnsTurnIdFeedbackPost(requestParameters.chatId, requestParameters.turnId, requestParameters.turnFeedbackWrite, options).then((request) => request(this.axios, this.basePath));
    }
