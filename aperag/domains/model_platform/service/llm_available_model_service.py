...
class LlmAvailableModelService:
    ...
    async def get_available_models(self, user_id: str, tag_filter_request: TagFilterRequest) -> ModelConfigList:
        ...
        return ModelConfigList(items=filtered_providers, pageResult=None)

    def _build_provider_configs_from_data(self, available_providers, provider_models) -> List[ModelConfig]:
...
def filter_models_by_tags(models: List[dict], tag_filters: Optional[List[TagFilterCondition]]) -> List[dict]:
...
def filter_providers_by_tags(
    providers: List[ModelConfig], tag_filters: Optional[List[TagFilterCondition]]
) -> List[ModelConfig]:
    ...
    for provider in providers:
        ...
        if has_any_models:
            filtered_providers.append(ModelConfig(**provider_dict))
