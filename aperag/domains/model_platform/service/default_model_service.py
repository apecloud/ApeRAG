...
class DefaultModelService:
    ...
    async def get_default_models(self, user_id: str) -> DefaultModelsResponse:
        ...
        for scenario in scenarios:
            ...
            if selected_model:
                ...
                default_configs.append(DefaultModelConfig(scenario=scenario, provider_name=None, model=None))

        return DefaultModelsResponse(items=default_configs)
    ...
    async def update_default_models(
        self, user_id: str, update_request: DefaultModelsUpdateRequest
    ) -> DefaultModelsResponse:
        ...
        for config in update_request.defaults:
            if config.provider_name and config.model:
                ...
                # Allow both public providers and user's own providers to be set as default.
        ...
        async def _update_operation(session):
            ...
            for config, api_type in validated_configs:
                ...
                from aperag.domains.model_platform.db.models import LLMProvider, LLMProviderModel
                ...
                stmt = (
                    ...
                    .where(
                        ...
                        # Removed: LLMProvider.user_id == "public"
                    )
                )
