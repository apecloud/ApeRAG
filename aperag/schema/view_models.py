...
#   timestamp: 2025-08-13T06:14:29+00:00
...
class CleanupTempDocumentsRequest(BaseModel):
    document_ids: list[str] = Field(
        ..., description='List of temporary document IDs to cleanup', min_items=1
    )


class CleanupTempDocumentsResponse(BaseModel):
    ...
    failed_documents: Optional[list[FailedDocument]] = Field(
        None, description='Details of failed deletions'
    )
