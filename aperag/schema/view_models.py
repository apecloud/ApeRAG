...
#   timestamp: 2025-08-18T03:51:40+00:00
...
class PaginatedResponse(BaseModel):
    total: Optional[conint(ge=0)] = Field(
        None, description='Total number of items', example=100
    )
    ...
    has_next: Optional[bool] = Field(
        None, description='Whether there is a next page', example=True
    )
    has_prev: Optional[bool] = Field(
        None, description='Whether there is a previous page', example=False
    )
...
class CollectionViewList(PaginatedResponse):
    """
