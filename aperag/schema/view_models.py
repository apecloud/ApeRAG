...
#   timestamp: 2025-08-05T08:31:30+00:00
...
class QuotaUpdateRequest(BaseModel):
    ...
    quota_type: Literal[
        ...
        ..., description='Type of quota to update', example='max_collection_count'
    )
    new_limit: conint(ge=0) = Field(..., description='New quota limit', example=20)
...
class QuotaUpdateResponse(BaseModel):
    ...
    message: str = Field(
        ..., description='Status message', example='Quota updated successfully'
    )
