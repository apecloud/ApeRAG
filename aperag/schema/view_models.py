...
#   timestamp: 2025-07-11T06:21:27+00:00
...
class SuggestionActionRequest(BaseModel):
    ...
    action: Literal['accept', 'reject'] = Field(
        ..., description='Action to take on the suggestion', example='accept'
    )
...
class SuggestionActionResponse(BaseModel):
    ...
    action: Literal['accept', 'reject'] = Field(
        ..., description='The action that was performed', example='accept'
    )
