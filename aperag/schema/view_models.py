...
#   timestamp: 2025-08-22T08:29:55+00:00
...
class ChatDocumentResponse(BaseModel):
    ...
    status: Optional[
        Literal['UPLOADING', 'PENDING', 'RUNNING', 'COMPLETE', 'FAILED']
    ] = Field(None, description='Document processing status')
    chat_id: Optional[str] = Field(None, description='Chat session ID')
    message_id: Optional[str] = Field(
        None, description='Message ID that the document is associated with'
    )
    created: Optional[datetime] = Field(None, description='Creation timestamp')
    updated: Optional[datetime] = Field(None, description='Last update timestamp')


class ChatDocumentList(BaseModel):
    items: Optional[list[ChatDocumentResponse]] = Field(
        None, description='List of chat documents'
    )
