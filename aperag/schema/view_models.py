...
#   timestamp: 2025-06-23T07:36:11+00:00
...
class SuccessResponse(BaseModel):
    code: Optional[str] = Field(None, description='Success code', example='200')
    message: Optional[str] = Field(
        None, description='Success message', example='Operation completed successfully'
    )
